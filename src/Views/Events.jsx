...
import details1 from "../Images/details/details1.jpg";
import details2 from "../Images/details/details2.jpg";
import details3 from "../Images/details/details3.jpg";
  ...
  return (
    <section id="events">
      <Container>
        ...
        <Fade direction="left" duration={500} delay={600} triggerOnce>
          <Row className="mb-5 mb-lg-0">
            <Col lg={8} className="p-4">
              <img src={details1} alt="Details3" data-cursor-text="Check out" />
            </Col>
        ...
        <div className="pc">
          <Fade direction="right" duration={500} delay={600} triggerOnce>
            <Row className="mb-5 mb-lg-0">
              <Col lg={4} className="col-description">
                <div>
                  <h3 style={{ fontWeight: "normal" }}>
              ...
              <Col lg={8} className="p-4">
                <img src={details2} alt="Details2" data-cursor-text="Check out" />
              </Col>
            </Row>
          </Fade>
        </div>
        ...
        <Fade direction="left" duration={500} delay={600} triggerOnce>
          <Row className="mb-5 mb-lg-0">
            <Col lg={8} className="p-4">
              <img src={details3} alt="Details1" data-cursor-text="Check out" />
            </Col>
            ...
            <Col lg={4} className="col-description">
              <div>
                ...
                <a href="https://www.instagram.com/isf_calpoly/">
                  <span className="button button-hero">Join our Ins group</span>
                </a>
              </div>
            </Col>
          </Row>
